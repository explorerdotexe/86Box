...
int
machine_at_mb500n256_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/mb500n256/031396s.bin",
			   0x000c0000, 262144, 0);
...
machine_at_president_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/president/bios.bin",
			   0x000e0000, 131072, 0);

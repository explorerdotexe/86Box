...
int
machine_at_p6sba256_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6sba256/SBAB21.ROM",
			   0x000c0000, 262144, 0);
...
int
machine_at_p6sba128_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p6sba128/128k.ROM",
			   0x000e0000, 131072, 0);

...
int
machine_at_vi15g64_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vi15g64/vi15gr23.rom",
			   0x000f0000, 65536, 0);
...
int
machine_at_vi15g128_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vi15g128/128k.rom",
			   0x000e0000, 131072, 0);
